...
acqXML <- TextDocCol(DirSource(acqDir), parserControl = list(parser = readReut21578XML, language = "en_US", load = TRUE))
...
crudeXML <- TextDocCol(DirSource(crudeDir), parserControl = list(parser = readReut21578XML, language = "en_US", load = TRUE))
