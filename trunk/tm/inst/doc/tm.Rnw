...
(OvidTDC <- TextDocCol(DirSource(txt), load = TRUE))
@
...
(reut21578TDC <- TextDocCol(DirSource(reut21578), readReut21578XML))

TextDocCol(ReutersSource(reut21578XML), readReut21578XML)
TextDocCol(ReutersSource(gzfile(reut21578XMLgz)), readReut21578XML)
@
...
TextDocCol(ReutersSource(rcv1XML), readRCV1)
@
...
<<>>=
data(stopwordsEn)
reut21578TDC <- tmMap(reut21578TDC, removeWords, stopwordsEn)
@
