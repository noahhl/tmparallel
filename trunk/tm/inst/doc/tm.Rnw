...
reads in the whole input file and interprets its content as text.
...
#                       parserControl = list(parser = readPlain, language = "en_US", load = TRUE),
#                       dbControl = list(useDb = TRUE, dbName = "oviddb", dbType = "DB1")))
(ovid <- TextDocCol(DirSource(txt),
                       parserControl = list(parser = readPlain, language = "en_US", load = TRUE)))
@
...
(reut21578TDC <- TextDocCol(DirSource(reut21578),
                            parserControl = list(parser = readReut21578XML, language = "en_US", load = FALSE)))
...
TextDocCol(DirSource(rcv1),
           parserControl = list(parser = readRCV1, language = "en_US", load = TRUE))
TextDocCol(ReutersSource(rcv1XML),
           parserControl = list(parser = readRCV1, language = "en_US", load = FALSE))
@
...
TextDocCol(DirSource(newsgroup),
           parserControl = list(parser = readNewsgroup, language = "en_US", load = TRUE))
@
...
TextDocCol(GmaneSource(rss),
           parserControl = list(parser = readGmane, language = "en_US", load = FALSE))
@
