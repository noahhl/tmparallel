...
<<>>=
tm_filter(reut21578.tdc, FUN = fulltext_search_filter, "partnership")
@

\subsection{Adding Data or Metadata}
Text documents or metadata can be added to text document collections
with \code{attach\_data} and \code{attach\_metadata}, respectively.
<<>>=
data(crude)
reut21578.tdc <- attach_data(reut21578.tdc, crude[[1]])
reut21578.tdc <- attach_metadata(reut21578.tdc, "modified", date())
summary(reut21578.tdc)
GlobalMetaData(reut21578.tdc)
@
...
GlobalMetaData(reut21578.tdc[1:2])
@
